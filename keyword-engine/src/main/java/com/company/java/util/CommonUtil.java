...
import com.company.java.exception.InvalidArgumentException;
...
public class CommonUtil {
	...
	public static double double4Two(double number) {
		double f = 111231.5585;
		BigDecimal format = new BigDecimal(f);
		double result = format.setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
		return result;
	}
	...
	public static void main(String[] args) {
		System.out.println((getRandom()+"123").substring(6));
	}
}
